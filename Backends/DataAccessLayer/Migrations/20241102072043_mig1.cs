        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ArticleDetails_Categories_CategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MentorSocialMedias", x => new { x.MentorId, x.SocialMediaId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArticleTags", x => new { x.ArticleDetailId, x.TagId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArticleDetails_CategoryId",
                table: "ArticleDetails",
                column: "CategoryId");
